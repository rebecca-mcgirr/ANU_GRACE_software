...
subroutine quat_mul_quad ( q1, q2, q3 )
!
!*******************************************************************************
!
...
!
  real(kind=16) :: q(4)
  real(kind=16) :: quat_norm_quad
!
  quat_norm_quad = sqrt ( sum ( q(1:4)**2 ) )

  return
end

subroutine rotation_axis2quat_3d_quad ( axis, angle, q )
!
!*******************************************************************************
!
...
subroutine rotation_quat2axis_3d_quad ( q, axis, angle )
!
!*******************************************************************************
!
...
!
  real(kind=16) :: axis(3)
  real(kind=16) :: angle
  real(kind=16) :: cos_phi
  real(kind=16) :: q(4)
  real(kind=16) :: sin_phi
!
...
subroutine rotation_mat2quat_3d_quad ( a, q )
!
!*******************************************************************************
!
...
subroutine rotation_quat2mat_3d_quad ( q, a )
!
!*******************************************************************************
!
...
subroutine quat_rot_vect_quad ( q, v, w )
!
!*******************************************************************************
!
...
subroutine quat_to_rpy_quad( quat, roll, pitch, yaw )
!
...
! 10 April 2013
  ...
  real(kind=16) quat(4),yaw,pitch,roll
...
subroutine quat_to_rpy_new_quad( quat, roll, pitch, yaw )
!
! subroutine to compute from a quaternion the corresponding yaw, pitch and roll angles
!
! P. Tregoning
...
subroutine quat_to_ypr_new_quad( quat, roll, pitch, yaw )
!
! subroutine to compute from a quaternion the corresponding yaw, pitch and roll angles
!
! P. Tregoning
...
subroutine quat_to_ypr_quad( quat, roll, pitch, yaw )
!
! subroutine to compute from a quaternion the corresponding yaw, pitch and roll angles
!
! P. Tregoning
