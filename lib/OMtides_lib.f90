!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!! OM tide code that was NOT variable declarations moved out of mod_subs/oceantides.f90
!
! P. Tregoning
! 29 April 2022
!
!
! OCT_read_file     :   reads in the OM tide model
! OCT_CS            :   calculates the C/S coefficients
...
! code to read some ocean tide information. Originally coded by Seb inside mod_subs/oceantides.f90. Moved to OMtides_lib.f90 by
! P. Tregoning
! 29 April 2022
