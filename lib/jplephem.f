...
! PT121211: add a dimension of PNUT to make it compatible with how it is used in subroutine STATE
      dimension pnut(4)
...
C
      KM=.TRUE. !EKP edit for use in orbit integrator
      ET2(1)=ET
      ET2(2)=0.D0
      GO TO 11
...
! PT121211: changed dimensioning of "list" from 11 to 12 to match required size in the subroutine
