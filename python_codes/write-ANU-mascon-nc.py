...
aewh_arr.units = 'm'
aewh_arr.description='estimated mascon equivalent water height anomaly'
aewh_arr[:]=aus_ewh[:,:]
# australia sigma
asigma_arr= ncw.createVariable('sigma', 'f4', (('nbp','nbt')))
asigma_arr.units = '(m)'
asigma_arr.description='formal uncertainty of mascon EWH'
