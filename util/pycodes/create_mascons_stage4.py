...
def main():
    ...
    if fo==1:
        ...
        try:
            ...
            sfile.write("~/gt/util/pycodes/grab_arctic_ocean.py %s --out_masconfile=%s. Timetag: %s. \n"%(tempfile,tempfile,str(datetime.datetime.now())))
    ...
    try:
        ...
        sfile.write("Keyboard interrupt during ~/gt/util/pycodes/move_ternaries_in_bigger_region.py %s --out_masconfile=%s --minsize=10 --maxdist=1000 --ftype=1. Timetag: %s. \n"%(tempfile,tempfile,str(datetime.datetime.now())))
    else:       
