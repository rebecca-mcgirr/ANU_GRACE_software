...
for cpt in np.arange(startloop,endloop):
    ...
    for myday in daylist:        
        ...
        print('## plt_resid_%s_%s_%s_10cm.kb and plt_resid_%s_%s_%s_10cm.kba copied to %s'%(myyear,mymonth,myday,myyear,mymonth,myday,monthly_dir))
        print('')      
        if os.path.isfile(daily_dir+'msc_%s_%s_%s_bom.vcv'%(myyear,mymonth,myday)): 
            ...
            print('## plt_resid_%s_%s_%s_bom.kb and plt_resid_%s_%s_%s_bom.kba copied to %s'%(myyear,mymonth,myday,myyear,mymonth,myday,monthly_dir))
            print('')      
        if os.path.isfile(daily_dir+'msc_%s_%s_%s_20cm.vcv'%(myyear,mymonth,myday)): 
            ...
            print('## plt_resid_%s_%s_%s_20cm.kb and plt_resid_%s_%s_%s_20cm.kba copied to %s'%(myyear,mymonth,myday,myyear,mymonth,myday,monthly_dir))
            print('')                 
