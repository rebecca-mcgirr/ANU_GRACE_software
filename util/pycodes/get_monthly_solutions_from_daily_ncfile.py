...
parser.add_argument("datadir",default="/Gdata/GRAV/GRACE/solutions/raijin/batch6z",type=str,help="complete path to your daily solutions")
parser.add_argument("--ncfile",default='/scratch/compute1/julia/solutions/ncfiles/batch6z_daily.nc',type=str,help="netcdffile compiling daily fitfiles")
...
parser.add_argument("--mcfile",default='~/gg/grace/tables/mascons_stage5_V004',type=str,help="mascon file for the inversion")
parser.add_argument("--regfile",default='~/gg/grace/tables/mascons_stage5_V004.reg',type=str,help="regularisation file for the inversion")
parser.add_argument("--prefix",default='default',type=str,help="prefix to identify regulaiation in output vcv and fit file")
