...
~/gt_nogamit/com/sh_setup_grace_lachland -t $yr $month $day 00 00 00 $iter0_duration -mission $mission -type $gtorb_type -acc_model $acc_model_AT $acc_model_CT $acc_model_RD -mascon_file ~/gg/grace/tables/mascons_stage5_V005_200km -extend 21600 -mascon_surface topography -msc_apriori_model ~/gg/grace/tables/apriori_batch7z_Tik2.5mm_adapt_casp20mm_5yr.txt
...
${version}/gracefit/gracefit gracefit_IC_iter0.cmd IC_${yr}_${month}_${day}_iter0.rms 4 GTORB_${yr}-${month}-${day}_00-00-00_${sat1}_${RL_num}_IC_iter0.$gtorb_type GTORB_${yr}-${month}-${day}_00-00-00_${sat2}_${RL_num}_IC_iter0.$gtorb_type $yr $month $day 
...
~/gt_nogamit/com/sh_setup_grace_210913 -t $yr $month $day 00 00 00 $iter1_duration -mission $mission -type $gtorb_type -acc_model $acc_model_AT $acc_model_CT $acc_model_RD -mascon_file ~/gg/grace/tables/mascons_stage5_V005_200km -extend 21600 -mascon_surface topography -msc_apriori_model ~/gg/grace/tables/apriori_batch7z_Tik2.5mm_adapt_casp20mm_5yr.txt
...
# run gracefit, estimating pos/vel/scl/bias (no mascons)
setenv OMP_NUM_THREADS 1
${version}/gracefit/gracefit gracefit_IC_iter1.cmd IC_${yr}_${month}_${day}_iter1.rms 4 GTORB_${yr}-${month}-${day}_00-00-00_${sat1}_${RL_num}_IC_iter1.$gtorb_type GTORB_${yr}-${month}-${day}_00-00-00_${sat2}_${RL_num}_IC_iter1.$gtorb_type $yr $month $day 
...
# run gracefit, estimating pos/vel/scl/bias (no mascons).
setenv OMP_NUM_THREADS 1
${version}/gracefit/gracefit gracefit_IC_iter2.cmd IC_${yr}_${month}_${day}_iter2.rms 4 GTORB_${yr}-${month}-${day}_00-00-00_${sat1}_${RL_num}_IC_iter2.$gtorb_type GTORB_${yr}-${month}-${day}_00-00-00_${sat2}_${RL_num}_IC_iter2.$gtorb_type $yr $month $day 
...
~/gt/util/apriori_mascons ~/gg/grace/tables/mascons_stage5_V005_200km /home/geod/lachland/gg/grace/tables/apriori_b7i1d_c4_2yr.txt ${yr} ${month} ${day} ~/gg/grace/tables/mascons_stage5_V005_200km 3
